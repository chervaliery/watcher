...
class WatchedApplicationAdmin(admin.ModelAdmin):
    list_display = ('name', 'base_url', 'hostname', 'check_interval_seconds', 'is_active', 'client_p12_path', 'updated_at')
...
class CheckResultAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('watched_application', 'checked_at', 'status_code', 'response_time_ms', 'success', 'error_message')
